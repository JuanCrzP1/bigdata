...
try:
    ...
    # El cuadro del informe pide el tiempo en milisegundos
    tiempo_procesamiento = (tiempo_final - tiempo_inicial) * 1000
    print("Tiempo de procesamiento: ", round(tiempo_procesamiento), "milisegundos")
